...
echo -e ""
echo -e "     ${BICyan}[${BIWhite}01${BICyan}] Add Account Socks      "
echo -e "     ${BICyan}[${BIWhite}02${BICyan}] Delete Account Socks      "
echo -e "     ${BICyan}[${BIWhite}03${BICyan}] Renew Account Socks      "
