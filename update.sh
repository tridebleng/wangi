...
sleep 2
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/artanodrop/dxavier/main/update/menu.sh" && chmod +x /usr/bin/menu
...
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/artanodrop/dxavier/main/update/menu-vmess.sh" && chmod +x /usr/bin/menu-vmess
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/artanodrop/dxavier/main/update/menu-vless.sh" && chmod +x /usr/bin/menu-vless
...
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/artanodrop/dxavier/main/update/menu-ssh.sh" && chmod +x /usr/bin/menu-ssh
